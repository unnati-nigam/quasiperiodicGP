...
% ----------------- Prepare x-axis -----------------
x = 0:(par.p-1)/2;       % lag values for x-axis
...
% ----------------- Export Figure -----------------
exportgraphics(gca, 'sunspot_general_kappa.pdf', 'ContentType','vector','BackgroundColor','None');
...
% ----------------- Export Figure -----------------
exportgraphics(gca, 'sunspot_kappa_se.pdf', 'ContentType','vector','BackgroundColor','none');
